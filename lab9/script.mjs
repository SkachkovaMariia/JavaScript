...
// TASK 5
import { getRandomInt, getRandomIntegersArray, getRandomTextFragment } from './randomModule.js';

const randomInt = getRandomInt(1, 10);
console.log('Random int:', randomInt);

const randomIntegersArray = getRandomIntegersArray(5, 1, 10);
console.log('Randon int array:', randomIntegersArray);

const textFragments = ['test', 'module', 'JS', 'random'];
const randomTextFragment = getRandomTextFragment(textFragments);
